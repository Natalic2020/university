...
public class Report {
    ...
    public void outputTeacherSchedule(String lastName, LocalDate startPeriod) {
        ...
        scheduleItemService.addScheduleItem(new ScheduleItemDto().setId(UUID.fromString("5e9330ba-162f-45ea-b9de-605ae734f585")));
        scheduleItemService.addScheduleItem(new ScheduleItemDto().setId(UUID.fromString("a8ee0b44-e269-424f-8c33-74d145aaf8d1")));
        scheduleItemService.addScheduleItem(new ScheduleItemDto().setId(UUID.fromString("92f6742f-ab90-4975-9f50-bbf4a3a99c74")));
        scheduleItemService.addScheduleItem(new ScheduleItemDto().setId(UUID.fromString("c38685d8-5c63-46af-8584-6001273a775a")));
                  
 
        System.out.println("--------------Week------------------");
        List<ScheduleItemDto> schedule1 = scheduleItemService.findWeekScheduleTeacher(lastName, startPeriod);
    ...
    public void outputStudentSchedule(String lastName, LocalDate startPeriod) {
        ...
        System.out.println("--------------Week------------------");
        List<ScheduleItemDto> schedule1 = scheduleItemService.findWeekScheduleStudent(lastName, startPeriod);
        schedule1.forEach(e -> System.out.println(e.toString()));
